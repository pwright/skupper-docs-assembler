...
Once you've installed Antora and {url-demo-playbook}[saved the demo playbook] ([.path]_antora-playbook.yml_) to a local directory, you're ready to {url-docs-run}[run Antora].
